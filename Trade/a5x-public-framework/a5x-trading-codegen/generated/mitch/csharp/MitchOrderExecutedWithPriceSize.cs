...
namespace A5X.Trading.Mitch.Model
{
    ...
    public class MitchOrderExecutedWithPriceSize
    {
        ...
        /// </summary>
        public byte Printable { get; set; }

        public static void Parse(MitchOrderExecutedWithPriceSize msg, Span<byte> data)
        {
            int offset = 0;
            ...
            offset += 6;
            msg.DisplayQuantity = BitConverter.ToUInt32(data.Slice(offset, 4));
            offset += 4;
            msg.Printable = data[offset++];
        }

        public static void Encode(MitchOrderExecutedWithPriceSize msg, Span<byte> data)
        {
            int offset = 0;
            ...
            offset += 6;
            BitConverter.TryWriteBytes(data.Slice(offset, 4), msg.DisplayQuantity);
            offset += 4;
            data[offset++] = (byte)msg.Printable;
        }
    }
}
