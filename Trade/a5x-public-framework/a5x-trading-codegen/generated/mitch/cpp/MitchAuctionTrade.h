#ifndef MITCHAUCTIONTRADE_H
#define MITCHAUCTIONTRADE_H
...
struct MitchAuctionTrade {
    ...
    static void parse(MitchAuctionTrade& msg, const uint8_t* data) {
        size_t offset = 0;
    ...
    static void encode(const MitchAuctionTrade& msg, uint8_t* data) {
        size_t offset = 0;
