#ifndef MITCHORDEREXECUTED_H
#define MITCHORDEREXECUTED_H
...
struct MitchOrderExecuted {
    ...
    static void parse(MitchOrderExecuted& msg, const uint8_t* data) {
        size_t offset = 0;
    ...
    static void encode(const MitchOrderExecuted& msg, uint8_t* data) {
        size_t offset = 0;
