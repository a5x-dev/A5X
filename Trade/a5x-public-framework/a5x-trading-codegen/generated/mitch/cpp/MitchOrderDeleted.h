#ifndef MITCHORDERDELETED_H
#define MITCHORDERDELETED_H
...
struct MitchOrderDeleted {
    ...
    static void parse(MitchOrderDeleted& msg, const uint8_t* data) {
        size_t offset = 0;
    ...
    static void encode(const MitchOrderDeleted& msg, uint8_t* data) {
        size_t offset = 0;
