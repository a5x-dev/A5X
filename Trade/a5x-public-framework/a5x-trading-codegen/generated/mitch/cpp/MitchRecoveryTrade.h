#ifndef MITCHRECOVERYTRADE_H
#define MITCHRECOVERYTRADE_H
...
struct MitchRecoveryTrade {
    ...
    static void parse(MitchRecoveryTrade& msg, const uint8_t* data) {
        size_t offset = 0;
    ...
    static void encode(const MitchRecoveryTrade& msg, uint8_t* data) {
        size_t offset = 0;
